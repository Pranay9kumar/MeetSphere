      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#tech-stack" className="text-on-surface-variant hover:text-primary transition-colors">Tech Stack</a>
            <a href="#architecture" className="text-on-surface-variant hover:text-primary transition-colors">Architecture</a>
            <a href="#team" className="text-on-surface-variant hover:text-primary transition-colors">Team</a>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden glass-card border-t border-white/10 dark:border-white/5 animate-in slide-in-from-top-2">
          <div className="px-4 pt-2 pb-6 space-y-4">
            ...
            <a href="#tech-stack" className="block text-on-surface-variant hover:text-primary transition-colors px-2 py-1" onClick={() => setIsOpen(false)}>Tech Stack</a>
            <a href="#architecture" className="block text-on-surface-variant hover:text-primary transition-colors px-2 py-1" onClick={() => setIsOpen(false)}>Architecture</a>
            <a href="#team" className="block text-on-surface-variant hover:text-primary transition-colors px-2 py-1" onClick={() => setIsOpen(false)}>Team</a>
